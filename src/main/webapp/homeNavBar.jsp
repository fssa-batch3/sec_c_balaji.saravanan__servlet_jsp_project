<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
	<div class="container-fluid">
		<a class="navbar-brand text-danger" href="">POLITIFACT</a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link list_li" href=""
					id="option_four">Past Leader</a></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle list_li" href="#"
					id="navbarDropdown" role="button" data-bs-toggle="dropdown"
					aria-expanded="false" id="five_option"> More </a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item text-dark list_li" href=""
							id="option_five_sub_one">Governer</a></li>
						<li><a class="dropdown-item text-dark list_li" href=""
							id="option_five_sub_two">MLA</a></li>
						<li><a class="dropdown-item text-dark list_li" href=""
							id="option_five_sub_two">Budget</a></li>
					</ul></li>
			...
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item dropdown" id="option_six"><a
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item text-dark list_li" href="">Register</a></li>
					</ul></li>
			</ul>
		</div>
	</div>

...
<jsp:include page="${request.getContextPath()}/homeNavBar.jsp"></jsp:include>
    ...
    <div class="mla-list-intro">
        <div>
            ...
            <p>தமிழ்நாடு சட்டசபையில் 234 தொகுதிகள் உள்ளன. கடைசியாக தமிழ்நாடு சட்டசபைக்கு எம்எல்ஏக்கள் தேர்வு
                செய்யப்பட்டது மே 2021. திமுக வென்ற தொகுதிகள் 125, அதிமுக வென்ற தொகுதிகள் 65 இடங்கள், மற்றவர்கள் வென்றது
                44 தொகுதிகள். தமிழ்நாடு சட்டசபைத் தேர்தலில் ஒவ்வொரு கட்சியிலிருந்தும் வென்றவர்களின் விரிவான பட்டியல்.
            </p>
        </div>
        <div>
            <p>
                உங்கள் தொகுதி உங்களுக்குத் தெரியாவிட்டால், உங்கள் வாக்காளர் அடையாள அட்டையின் பின்புறம் உள்ள சட்டமன்றத்
                தொகுதி எண் & பெயரைப் பயன்படுத்தி உங்கள் தொகுதியைக் காட்டும் உள்ளீட்டு புலத்தில் அந்த எண்ணைத்
                தேடலாம்.<img src="../../assets/images/essecial/IMG_20230427_140143.jpg"
                    style="width: 400px; height: 100px;" alt=""></p>
        </div>
    </div>
    ...
    <div class="total_div">
        ...
        <div class="bar-chart">
            <p class="chartheading">
                தமிழ்நாடு வரைபடம்</p>
            <svg width="900" height="900">
                <g>
                    <circle cx="20" cy="25" r="10" fill="#006400"></circle><text x="35" y="30">All India Anna Dravida
                        Munnetra Kazhagam</text>
                    <circle cx="20" cy="50" r="10" fill="#ff8c00"></circle><text x="35" y="55">Bharatiya Janata
                        Party</text>
                    <circle cx="20" cy="75" r="10" fill="#ff0000"></circle><text x="35" y="80">Communist Party of
                        India</text>
                    <circle cx="20" cy="100" r="10" fill="#ff0000"></circle><text x="35" y="105">Communist Party of
                        India
                        (Marxist)</text>
                    <circle cx="20" cy="125" r="10" fill="#800000"></circle><text x="35" y="130">Dravida Munnetra
                        Kazhagam</text>
                    <circle cx="20" cy="150" r="10" fill="#228b22"></circle><text x="35" y="155">Indian National
                        Congress</text>
                    <circle cx="20" cy="175" r="10" fill="#ffff00"></circle><text x="35" y="180">Pattali Makkal
                        Katchi</text>
                    <circle cx="20" cy="200" r="10" fill="#1e90ff"></circle><text x="35" y="205">Viduthalai Chiruthaigal
                        Katchi</text>
                </g>
                <g class="winners-map">
        ...
        <div class="table-container" id="table-container" style="display: none;">
            ...
            <table class="district-table">
                <thead>
                    <tr>
                        <th>வேட்பாளர் பெயர்</th>
                        <th>கட்சி</th>
                        <th>தொகுதி</th>
                        <th>வாக்குகள்</th>
                        <th>வாக்கு விகிதம்</th>
                    </tr>
                </thead>
    ...
    <p class="chartheading">கட்சி வெற்றி அட்டவணை</p>
    ...
    <div class="governer ">
        ...
        <table class="table table-hover" id="mlatable">
            ...
            <thead id="head_tamil">
                ...
                <th class="text-center">தொகுதி பெயர் <button id="sortName"><i class="fa fa-sort"></button></th>
                <th class="text-center">வேட்பாளர் பெயர்</th>
                <th class="text-center">கட்சிகள்</th>
                <th class="text-center">வாக்குகள்</th>
                <th class="text-center">வாக்கு வித்தியாசம்<button id="sortMargin"><i class="fa fa-sort"></button></th>
    ...
    <script>
        ...
        districts.forEach(function (district) {
            district.addEventListener('click', function (event) {
                ...
                // Translate the content of the tbody rows
                if (localStorage.getItem("language") === "tamil") {
                    const targetLanguage = "ta"; // translate to Tamil

                    const rowsToTranslate = tableContainer.querySelectorAll(".table-row tr");

                    rowsToTranslate.forEach(function (row) {
                        const cellsToTranslate = row.querySelectorAll("td");

                        cellsToTranslate.forEach(function (cell) {
                            ...
                            fetch(translateUrl)
                                ...
                                .then((data) => {
                                    ...
                                    cell.textContent = translatedText; // update the cell with the translated text
                                })
    ...
    const mla_list_tamil = JSON.parse(localStorage.getItem("mla_details_english"));
    ...
    <script src="../../assets/javascript/mla_list.js"></script> -->

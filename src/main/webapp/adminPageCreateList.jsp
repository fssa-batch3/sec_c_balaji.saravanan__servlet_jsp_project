...
.dropdown-content {
    ...
    z-index: 1;
    margin-top: 5px; /* Adjust the margin to control the spacing */
}
...
/* Style for the last dropdown option */
.dropdown-option:last-child {
    z-index: 2; /* Adjust the z-index value as needed */
}

/* Style for the Verify option */
.dropdown-option[data-status="VERIFY"] {
    background-color: green;
    color: white;
}

/* Style for the Reject option */
.dropdown-option[data-status="REJECT"] {
    background-color: red;
    color: white;
}

/* Style for the Inprogress option */
.dropdown-option[data-status="Inprogress"] {
    background-color: yellow;
    color: black;
}

/* Style for the Baned option */
.dropdown-option[data-status="BANED"] {
				...
				<div class="container-fluid">
					...
					<div class="card shadow border-0 mb-7">
									...
									<tr>
										...
										<td scope="col">
											<div class="dropdown-container">
												<button class="dropdown-button"><%=leader.getVerify()%></button>
												<div class="dropdown-content">
													<form action="Verify" method="post">
														<input type="hidden" name="status" value="VERIFY">
														<input type="hidden" name="id" value="<%=leader.getId()%>">
														<button type="submit" class="dropdown-option"
															data-status="VERIFY">Verify</button>
													</form>
													<form action="Verify" method="post">
													...
													<form action="Verify" method="post">
														<input type="hidden" name="status" value="BANED">
														<input type="hidden" name="id" value="<%=leader.getId()%>">
														<button type="submit" class="dropdown-option"
															data-status="BANED">Baned</button>
													</form>
												</div>
											</div>
										</td>
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="#" class="updateConstituency"
											...
											data-consname="<%=constituency.getConstituencyName()%>"
						...
						<div class="container" id="container2" style="display: none">
							...
							<form id="Constituenct-form" action="UpdateConstituency"
								method="post">
						...
						<div class="container" id="container3" style="display: none">
							...
							<form id="Party-form" action="UpadateParty" method="post">
...
<script>
    ...
    function assignParty(partyList){
    	...
    	document.getElementById("partyNames").value = partyList.partyname;
    ...
    updateParty.forEach(party => {
      ...
      party.addEventListener("click", () => {
        ...
        const partyList = {
          ...
          partyname: party.getAttribute("data-partyName"),
    ...
    function assignAffidavit(affidavit) {

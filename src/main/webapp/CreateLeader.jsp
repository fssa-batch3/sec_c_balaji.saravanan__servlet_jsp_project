				...
				<div class="container-fluid">
					<div class="mb-npx">
						...
						<ul class="nav nav-tabs mt-4 overflow-x border-0">
							<li class="nav-item"><a href="CreateLeader"
								class="nav-link active" onclick="showForm('container')">Leader
									create Page</a></li>
							<li class="nav-item"><a href="#"
								class="nav-link active" onclick="showForm('container1')">Affidavit
									create</a></li>
							<li class="nav-item"><a href="#"
								class="nav-link active" onclick="showForm('container2')">Constituency
									create</a></li>
							<li class="nav-item"><a href="#"
								class="nav-link active" onclick="showForm('container3')">Party
									create</a></li>
						</ul>
					</div>
				</div>
